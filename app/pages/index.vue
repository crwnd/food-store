	...
	meta: [
		{
			name: "description",
			content:
				"Свіжі овочі та фрукти прямо з грядки та саду. Доставка в Бровари та область. Замовляйте натуральні продукти без хімікатів.",
		},
	],
});
</script>
				...
				>
					<div class="p-6">
						...
						<p class="text-gray-600">
							Ми - родина фермерів, яка вирощує овочі та фрукти з
							любов'ю до землі та природи.
						</p>
					</div>
					<div class="p-6">
						<div class="text-4xl mb-4">🚫</div>
				...
				<div class="grid md:grid-cols-3 gap-8">
					<div class="bg-white p-8 rounded-2xl shadow-lg">
						...
						<p class="text-gray-600 mb-4">
							Забирайте замовлення прямо з нашої ферми. Попередньо
							телефонуйте для узгодження часу.
						</p>
